...
local function BuildOptionsPanel()
    ...
    awLblC1:SetPoint("RIGHT", panel,  "RIGHT", -16, 0)
    awLblC1:SetJustifyH("LEFT")
    ...
    awLblC2:SetPoint("RIGHT", panel,  "RIGHT", -16, 0)
    awLblC2:SetJustifyH("LEFT")
